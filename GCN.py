    ...
    *********************************************************
    ...
    if args.pretrain == 1:
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            log(f'load the pretrained model parameters from: {pretrain_path}')
    ...
    *********************************************************
    ...
    for epoch in range(1, args.epoch + 1):
        ...
        *********************************************************
        ...
        train_writer.add_summary(summary_train_acc, epoch // 10)
        ...
        *********************************************************
        ...
        train_writer.add_summary(summary_test_loss, epoch // 10)
        t2 = time()
        users_to_test = list(data_generator.test_set.keys())
        ret = test(sess, model, users_to_test, drop_flag=True)
        ...
        train_writer.add_summary(summary_test_acc, epoch // 10)
        ...
        if ret['recall'][0] == cur_best_pre_0 and args.save_flag == 1:
            ...
            log(f'save the weights in path: {weights_save_path}')
