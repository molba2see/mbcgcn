...
def parse_args():
    ...
    parser.add_argument('--weights_path', nargs='?', default='./mbcgcn-dataset/output/', help='Store model path.')
    parser.add_argument('--data_path', nargs='?', default='./mbcgcn-dataset/Data', help='Input data path.')   
    parser.add_argument('--proj_path', nargs='?', default='', help='Project path.') 
    parser.add_argument('--dataset', nargs='?', default='buy', help='Choose a dataset from {buy, order, cart, view, access}')                    
    parser.add_argument('--dataset1', nargs='?', default='buy', help='Choose a dataset from {buy, order, cart, view, access}')
    parser.add_argument('--dataset2', nargs='?', default='order', help='Choose a dataset from {buy, order, cart, view, access}')
    parser.add_argument('--dataset3', nargs='?', default='cart', help='Choose a dataset from {buy, order, cart, view, access}')
    parser.add_argument('--dataset4', nargs='?', default='view', help='Choose a dataset from {buy, order, cart, view, access}')
    parser.add_argument('--dataset5', nargs='?', default='access', help='Choose a dataset from {buy, order, cart, view, access}')
    ...
    parser.add_argument('--layer_size2', nargs='?', default='[64, 64, 64]', help='Output sizes of every layer')
    parser.add_argument('--layer_size3', nargs='?', default='[64, 64, 64, 64, 64]', help='Output sizes of every layer')
    parser.add_argument('--layer_size4', nargs='?', default='[64, 64, 64]', help='Output sizes of every layer')
